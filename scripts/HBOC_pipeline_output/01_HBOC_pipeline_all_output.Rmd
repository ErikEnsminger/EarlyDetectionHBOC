...
if (which_project == "control") {
  ...
  organized_dir <- 
    here::here("raw_data", "HBOC_pipeline_output", "20250129_HBC_CHARM_and_HCC_organized_outputs")
  ...
  organized_dir <- here::here(
    "raw_data", "HBOC_pipeline_output", "frag_pipeline_Oct9_organized_outputs"
  )

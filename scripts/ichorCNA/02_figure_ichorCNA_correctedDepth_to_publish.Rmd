...
ichorCNA <- read.delim(here::here("raw_data", "ichorCNA", "2025-02-28_ichorCNA_HBOC_Feb28_2025_ichorCNA_estimates.tsv"))
...
segs <- read.delim(here::here("data", "ichorCNA", "01_processing_ichorCNA_HBOC_Feb28_2025_segs.txt"))
...
data_ichorCNA <- cbind(data_ichorCNA, c(rep(4.87, nrow(data_ichorCNA))))

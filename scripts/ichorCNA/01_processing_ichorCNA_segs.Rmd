...
```{r}
paths <- here::here("raw_data", "ichorCNA", "ichorCNA_HBOC_Feb_28_raw_output")

# Project name
project <- "01_processing_ichorCNA_HBOC_Feb28_2025"

# Output directory (local CloudStorage)
outdir_segs <- here::here("data", "ichorCNA", "01_processing_ichorCNA_HBOC_Feb28_2025_segs")

...
# Read coverage data
TS_coverage <- read.csv("./raw_data/coverage/TS_coverage_summary_May27.csv", check.names = FALSE)
WGS_coverage <- read.csv("./raw_data/coverage/WGS_coverage_summary_May28.csv", check.names = FALSE)
cfMeDIP_coverage <- read.delim("./raw_data/coverage/cfMeDIP_aligned_reads.tsv", sep="\t")

# TS_coverage <- read.csv("./raw_data/coverage/TS_coverage_summary_V2.csv", check.names = FALSE)
# WGS_coverage <- read.csv("./raw_data/coverage/WGS_coverage_summary_V2.csv", check.names = FALSE)
...
# Preview merged data
merged_data <- samples %>% 
  select(group_id, timepoint, `Library Name`, TS, cfMeDIP, WGS_coverage, TS_coverage, cfMeDIP_total_reads)
```

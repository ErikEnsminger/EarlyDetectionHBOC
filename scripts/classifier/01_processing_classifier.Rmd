...
```{r}
mutation_vafs <- read_excel("./raw_data/mutations/HBOC_oncoplot_Oct2.xlsx")
...
# healthy_carriers_vs_control$consensus_griffin <- log1p(healthy_carriers_vs_control$consensus_griffin)
...
# combined_negative$consensus_griffin <- log1p(combined_negative$consensus_griffin)
...
# brca_carriers_positive_vs_negative$consensus_griffin <- log1p(brca_carriers_positive_vs_negative$consensus_griffin)
